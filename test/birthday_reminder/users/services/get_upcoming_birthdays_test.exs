defmodule BirthdayReminder.Users.Services.GetUpcomingBirthdaysTest do
  ...
  test "returns a list of users with upcoming birthdays" do
    user1 = insert(:user, birthday: Timex.shift(Timex.today(), days: 7), subscribed: true)
    _user2 = insert(:user, birthday: Timex.shift(Timex.today(), days: 7), subscribed: false)
    _user3 = insert(:user, birthday: Timex.shift(Timex.today(), days: 10), subscribed: true)
